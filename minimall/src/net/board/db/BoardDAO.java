...
public class BoardDAO {
	...
	public BoardBean getDetail(int num) throws Exception{
		...
		try{
			...
			pstmt = con.prepareStatement(
					"select * from qna_board where BOARD_NUM = ?");
			pstmt.setInt(1, num);
	...
	public boolean boardInsert(BoardBean board){
		...
		try{
			...
			pstmt=con.prepareStatement("select max(board_num) from qna_board");
			rs = pstmt.executeQuery();
			...
			sql="insert into qna_board (BOARD_NUM,BOARD_NAME,BOARD_PASS,BOARD_SUBJECT,";
	...
	public boolean boardModify(BoardBean modifyboard) throws Exception{
		...
		String sql="update qna_board set BOARD_SUBJECT=?,BOARD_CONTENT=? where BOARD_NUM=?";
	...
	public boolean boardDelete(int num){
		...
		String board_delete_sql="delete from qna_board where BOARD_num=?";
	...
	public void setReadCountUpdate(int num) throws Exception{
		...
		String sql="update qna_board set BOARD_READCOUNT = "+
	...
	public boolean isBoardWriter(int num,String pass){
		...
		String board_sql="select * from qna_board where BOARD_NUM=?";
